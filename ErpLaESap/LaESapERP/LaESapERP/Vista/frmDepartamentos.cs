...
namespace LaESapERP
{
    public partial class frmDepartamentos : Form
    {
        ...
        {
            InitializeComponent();
            SpecialMethods.Titulo(this, "Departamentos");
            Refrescar();
        }
        ...
        {
            var Negox = new DepartamentoBL();
            var Records = Negox.ObtenerDepartamentos();
        ...
        {
            frmDepartamento oF = new frmDepartamento();
        ...
        private void picEditar_Click(object sender, EventArgs e)
        {
            ...
            if (id != null)
            {
                frmDepartamento oF = new frmDepartamento(id);
        ...
        private void picBorrar_Click(object sender, EventArgs e)
        {
            ...
            if (id != null)
            {
                frmDepartamento oF = new frmDepartamento(id, true);
                Refrescar();
        ...
        {
            var Negox = new DepartamentoBL();
            var Records = Negox.ObtenerDepartamentosByFiltering(txtBuscar.Text);
            this.dataGridView1.DataSource = Records;
